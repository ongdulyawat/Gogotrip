...
import '../../widget/slide_location.dart';
...
class _FavouriteScreenState extends State<FavouriteScreen> {
            ...
            FirebaseFirestore.instance.collection('temples')
              ...
              for ( var x in value.docs){
                if(x.id == fieldFavourite[num]){
                  final docTempleRef = FirebaseFirestore.instance.collection('temples').doc(x.id);
            ...
            FirebaseFirestore.instance.collection('restaurants')
              ...
              for ( var r in value.docs){
                if(r.id == fieldFavourite[num]){
                  final docRestaurantRef = FirebaseFirestore.instance.collection('restaurants').doc(r.id);
            ...
            FirebaseFirestore.instance.collection('beaches')
              ...
              for ( var b in value.docs){
                if(b.id == fieldFavourite[num]){
                  final docBeachRef = FirebaseFirestore.instance.collection('beaches').doc(b.id);
            ...
            FirebaseFirestore.instance.collection('parks')
              ...
              for ( var p in value.docs){
                if(p.id == fieldFavourite[num]){
                  final docParkRef = FirebaseFirestore.instance.collection('parks').doc(p.id);
            ...
            FirebaseFirestore.instance.collection('cafes')
              ...
              for ( var c in value.docs){
                if(c.id == fieldFavourite[num]){
                  final docCafeRef = FirebaseFirestore.instance.collection('cafes').doc(c.id);
  ...
  print("CCCCC");
  print(idsCafe);
  print("RRRRRAAAATTTEEE");
  print(rateTem);
  print(rateBea);
  print(rateRes);
  print(ratePark);
  print(rateCafe);
    return _timerFinished ? Scaffold(
                                  ...
                                  decoration: BoxDecoration(
                                      image: DecorationImage(
                                          image: idsCafe[(5*index)+4] != ''
                                              ? NetworkImage(idsCafe[(5*index)+4])
                                              : AssetImage("assets/images/beach.png")
                                          as ImageProvider,
                                          fit: BoxFit.fill),
                                      color: Colors.white,
                          ...
                          decoration: BoxDecoration(
                              image: DecorationImage(
                                  image: idsPark[(5*index)+4] != ''
                                      ? NetworkImage(idsPark[(5*index)+4])
                                      : AssetImage("assets/images/beach.png")
                                  as ImageProvider,
                                  fit: BoxFit.fill),
                              color: Colors.white,
